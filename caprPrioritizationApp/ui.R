         ...
         sidebarLayout(
           ...
           sidebarPanel(
             ...
             selectInput("yourLocation","Enter Your Location:",c(
               ...
               "UC Berkeley BG" = "UCB",
               "Rae Selling Berry" = "BERR")),
             textInput("milesFrom","Miles from Your Location"),
             ...
             selectInput("landownBroad", 'Land Ownership Broad: ',choices=c("",unique(EOdata$BroadestOwnership)),selected='',multiple=TRUE),
             selectInput("nationalForest", 'Specific National Forest: ',choices=c("",unique(EOdata$forest)),selected='',multiple=TRUE),
             selectInput("specificLands","Other Specific Landownership: ", choices=c("",specificLandVec),selected='',multiple=TRUE),
