...
summAcc <- AccwithSpp[,
                      .(collectionTypes=toString(sort(unique(basisofRecord))),
                        ...
                        totalSeedCollections=sum(1*(basisofRecord=="Seed")),
...
# Making a matrix
traitDT <- summAcc[!is.na(nameOnPhylogeny),.(nameOnPhylogeny,collectionTypes,totalSeed,totalSeedCollections,totalColl,family,genus,institutions,CRPR,Counties)]
