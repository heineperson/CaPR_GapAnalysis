...
Spp1 <- Spp1[ grepl("1B",CRPR) |  grepl("2B",CRPR)| TJM1TJM2%in%c("TJM1","TJM2")]
...
# Writing data to the disc
  write.tree(result_california_speciesOnly$scenario.3,"Data/result_california_speciesOnly_20190919.tre")
  write.csv(result_california_speciesOnly$species.list,"Data/result_california_speciesOnly_20190919.csv")
...
write.tree(newTree, "Data/californiaTreewithInfraSpecies_20190919.tre")
