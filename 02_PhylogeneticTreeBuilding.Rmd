...
SppCopy[grepl(" x ", species),binomial:=ifelse(str_count(species," ")==3,binomial,word(species,1,3,sep=" "))]
...
SppCopy[,infraSpp := toString(species[(grepl("var.",species,fixed=T)|grepl("subsp.",species,fixed=T)|grepl(" x ",species,fixed=T))]),by="binomial"]
...
SppCopy[grepl(" x ",infraSpp,fixed=T),InfraType:="x"]
...
write.tree(newTree, "Data/californiaTreewithInfraSpecies_20190626.tre")
