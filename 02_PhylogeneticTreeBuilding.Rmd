...
###################### V Phylomaker  ########################
## Read in the megaphylogeny in S Phylomaker
GBOTB.extended<-load("Data/GBOTB.extended.rda") # read in the megaphylogeny.
nodes.info.1 <- load("Data/nodes.info.1.rda")
...
source("phylomaker_for_VPhylomaker.R")

## Bulding Tree for Scenario 3
result_california_tree <- phylo.maker(spList=as.data.frame(SppVas1), tree=phylo, nodes=nodes, scenarios=c("S1","S2","S3")) 
